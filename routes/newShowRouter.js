...
//               console.log('------------------------------------------------------')
	...
	show.save(function(err){
		if(err){
			...
			var nextAlertDay = Date.create('Next ' + show.airsDayOfWeek + ' at ' + show.airsTime).rewind({hour: 1});
			var thisAlertDay = Date.create('This ' + show.airsDayOfWeek + ' at ' + show.airsTime).rewind({hour: 1});
			var today = new Date();
			
			if( thisAlertDay < today ){
				//console.log('thisAlertDay is passed ' +thisAlertDay);
				var alertDate = nextAlertDay;
				
			}else{
				//console.log('thisAlertDay is comming up '+thisAlertDay);
				var alertDate = thisAlertDay;
			}
